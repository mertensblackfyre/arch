...
Item {
    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            color: "transparent"
            border.color: Qt.rgba(Config.Theme.primary.r, Config.Theme.primary.g, Config.Theme.primary.b, 0.80)
            border.width: 1.5
            opacity: 0
            scale: 0.08
            SequentialAnimation {
    ...
    Text {
        ...
        color: Qt.rgba(Config.Theme.primary.r, Config.Theme.primary.g, Config.Theme.primary.b, 0.55)
